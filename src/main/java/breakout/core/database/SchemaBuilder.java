...
/**
 * Provides functionality to build the database schema.
 */
public class SchemaBuilder implements DefaultDependenciesInjectable {
    ...
    /**
     * Similar functionality with {@link SchemaBuilder#createDatabase(String)}, but only done if table does not exist
     *
