...
/**
 * The default implementation and functionalities for each particle that involves a surmountable of physics.
 * Enables dynamic movement using physics including gravity and bounce, and ground level.
 */
